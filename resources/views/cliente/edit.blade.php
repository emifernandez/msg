                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" id="form" method="POST" action="{{ route('cliente.update', $cliente->id) }}" autocomplete="off">
                                @method('PATCH')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tipo_cliente" id="tipo_cliente">
                                                    @foreach($tipos_clientes as $key => $tipo_cliente)
                                                        <option value="{{ $key }}"
                                                            @if ($key == old('tipo_cliente', $cliente->tipo_cliente)) 
                                                                selected 
                                                            @elseif ($key == 1)
                                                                selected 
                                                            @endif
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="calificacion" id="calificacion">
                                                    ...
                                                    <option value="{{ $key }}"
                                                        @if ($key == old('calificacion', $cliente->calificacion)) 
                                                            selected
                                                        @endif
                                                        >{{ $calificacion }}</option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="estado" id="estado">
                                                    @foreach($estados as $key => $estado)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('estado', $cliente->estado)) selected @endif
                                                            >{{ $estado }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="fecha_ingreso"
                                                    id="fecha_ingreso"
                                                    value="{{ old('fecha_ingreso', $cliente->fecha_ingreso->forForm()) }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tipo_documento" id="tipo_documento">
                                                    @foreach($tipos_documentos as $key => $tipo_documento)
                                                        <option value="{{ $key }}"
                                                            @if ($key == old('tipo_documento', $cliente->tipo_documento)) 
                                                                selected
                                                            @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="genero" id="genero">
                                                    @foreach($generos as $key => $genero)
                                                        <option value="{{ $key }}"
                                                                @if($key == old('genero', $cliente->genero)) selected @endif
                                                                >{{ $genero }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <select class="form-control" name="organizacion_id" id="organizacion_id">
                                            ...
                                            @foreach($organizaciones as $key => $organizacion)
                                                <option value="{{ $organizacion->id }}"
                                                    @if($organizacion->id == old('organizacion_id', $cliente->organizacion_id)) selected @endif
