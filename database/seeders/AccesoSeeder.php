...
class AccesoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $acceso->descripcion = 'Productos Vendidos';
        $acceso->modulo = $menu->id;
        ...
        $acceso->save();
        $acceso = new Acceso();
        $acceso->nombre = 'venta-servicio-reporte';
        $acceso->descripcion = 'Servicios Vendidos';
        $acceso->modulo = $menu->id;
        $acceso->ruta = 'venta.servicio.reporte';
        $acceso->icono = 'fas fa-fw fa-print';
        $acceso->nivel = 2;
        $acceso->save();
        $acceso = new Acceso();
        $acceso->nombre = 'venta-reserva-reporte';
        $acceso->descripcion = 'Reservas Vendidas';
        $acceso->modulo = $menu->id;
        $acceso->ruta = 'venta.reserva.reporte';
        $acceso->icono = 'fas fa-fw fa-print';
        $acceso->nivel = 2;
        $acceso->save();
        $acceso = new Acceso();
